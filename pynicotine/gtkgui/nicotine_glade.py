...
class MainWindow:
	def __init__(self, create = True, accel_group = None, tooltips = None):
		...
		self.chat_rooms1.add_accelerator("activate", self.accel_group, gtk.gdk.keyval_from_name("1"), gtk.gdk.MOD1_MASK, gtk.ACCEL_VISIBLE)
		...
		self.private_chat1.add_accelerator("activate", self.accel_group, gtk.gdk.keyval_from_name("2"), gtk.gdk.MOD1_MASK, gtk.ACCEL_VISIBLE)
		...
		self.downloads1.add_accelerator("activate", self.accel_group, gtk.gdk.keyval_from_name("3"), gtk.gdk.MOD1_MASK, gtk.ACCEL_VISIBLE)
		...
		self.uploads1.add_accelerator("activate", self.accel_group, gtk.gdk.keyval_from_name("4"), gtk.gdk.MOD1_MASK, gtk.ACCEL_VISIBLE)
		...
		self.search_files1.add_accelerator("activate", self.accel_group, gtk.gdk.keyval_from_name("5"), gtk.gdk.MOD1_MASK, gtk.ACCEL_VISIBLE)
		...
		self.user_info1.add_accelerator("activate", self.accel_group, gtk.gdk.keyval_from_name("6"), gtk.gdk.MOD1_MASK, gtk.ACCEL_VISIBLE)
		...
		self.user_browse1.add_accelerator("activate", self.accel_group, gtk.gdk.keyval_from_name("7"), gtk.gdk.MOD1_MASK, gtk.ACCEL_VISIBLE)
		...
		self.interests1.add_accelerator("activate", self.accel_group, gtk.gdk.keyval_from_name("8"), gtk.gdk.MOD1_MASK, gtk.ACCEL_VISIBLE)
		...
		self.user_list1.add_accelerator("activate", self.accel_group, gtk.gdk.keyval_from_name("9"), gtk.gdk.MOD1_MASK, gtk.ACCEL_VISIBLE)
