...
class TransfersFrame:
	def __init__(self, create = True, accel_group = None, tooltips = None):
		...
		self.MaxUserQueue = gtk.SpinButton(gtk.Adjustment(value=100, lower=0, upper=1000000, step_incr=1, page_incr=10, page_size=10))
...
class BloatFrame:
	def __init__(self, create = True, accel_group = None, tooltips = None):
		...
		self.hbox9.pack_start(self.DefaultColours, False, True, 0)
		...
		self.hbox9.pack_start(self.ClearAllColours, False, True, 0)

		self.vbox8.pack_start(self.hbox9)
		...
		self.hbuttonbox1.pack_start(self.UsernameHotspots)
		...
		self.hbuttonbox1.pack_start(self.DisplayAwayColours)

		self.table1.attach(self.hbuttonbox1, 0, 3, 4, 5, gtk.EXPAND|gtk.FILL, gtk.FILL, 0, 0)
		...
		self.table1.attach(self.PickOnline, 0, 1, 5, 6, gtk.FILL, 0, 0, 0)
		...
		self.table1.attach(self.PickOffline, 0, 1, 6, 7, gtk.FILL, 0, 0, 0)
		...
		self.table1.attach(self.PickAway, 0, 1, 7, 8, gtk.FILL, 0, 0, 0)
		...
		self.table1.attach(self.DefaultOnline, 2, 3, 5, 6, gtk.FILL, 0, 0, 0)
		...
		self.table1.attach(self.DefaultOffline, 2, 3, 6, 7, gtk.FILL, 0, 0, 0)
		...
		self.table1.attach(self.DefaultAway, 2, 3, 7, 8, gtk.FILL, 0, 0, 0)
		...
		self.table1.attach(self.OnlineColor, 1, 2, 5, 6, gtk.EXPAND|gtk.FILL, 0, 0, 0)

		self.OfflineColor = gtk.Entry()
		self.OfflineColor.set_editable(False)
		self.OfflineColor.show()
		self.table1.attach(self.OfflineColor, 1, 2, 6, 7, gtk.EXPAND|gtk.FILL, 0, 0, 0)

		self.AwayColor = gtk.Entry()
		self.AwayColor.set_editable(False)
		self.AwayColor.show()
		self.table1.attach(self.AwayColor, 1, 2, 7, 8, gtk.EXPAND|gtk.FILL, 0, 0, 0)
		...
		self.table1.attach(self.hbox197, 0, 3, 8, 9, gtk.FILL, gtk.EXPAND|gtk.FILL, 0, 0)
		...
		self.vbox8.pack_start(self.woopBox)
		...
		self.OfflineSearch = gtk.Button()
		self.OfflineSearch.show()
		...
		self.OfflineSearch.add(self.alignment7)

		self.table7.attach(self.OfflineSearch, 0, 1, 2, 3, gtk.FILL, 0, 0, 0)
		...
		self.vboxUI.pack_start(self.ColoursExpander, False, False, 0)
		...
		self.MainTabsLabel.set_width_chars(12)
		...
		self.ChatRoomsLabel.set_width_chars(12)
		...
		self.PrivateChatLabel.set_width_chars(12)
		...
		self.SearchLabel.set_width_chars(12)
		...
		self.UserInfoLabel.set_width_chars(12)
		...
		self.UserBrowseLabel.set_width_chars(12)
		...
		self.vboxUI.pack_start(self.TabsExpander)
...
class SoundsFrame:
	def __init__(self, create = True, accel_group = None, tooltips = None):
		...
		self.image97.set_from_stock(gtk.STOCK_CLEAR, 4)
		self.image97.show()
		self.hbox229.pack_start(self.image97, False, False, 0)

		self.label383 = gtk.Label(_("Clear"))
		self.label383.show()
