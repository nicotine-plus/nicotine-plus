 ...
 * Make an android fork? ([#1470](https://github.com/nicotine-plus/nicotine-plus/issues/1470))
 ...
 * Option To Selectively Rescan Specific Folders ([#1514](https://github.com/nicotine-plus/nicotine-plus/issues/1514))
 ...
 * Resolve GTK 3.20 validation mismatch "Property 'X align' of object class 'name="xalign"' is deprecated" (all *.ui files) ([#1522](https://github.com/nicotine-plus/nicotine-plus/issues/1522))
 ...
 * Let the leech plugin browse user files, rather than user info ([#1589](https://github.com/nicotine-plus/nicotine-plus/issues/1589))
 ...
 * failure of some settings (3.2.0.dev1) ([#1624](https://github.com/nicotine-plus/nicotine-plus/issues/1624))
