...
class Config:
	...
	"login":None,"passw":None,"firewalled":1, "ctcpmsgs": 0,  \
...
# 		print self.sections[i][j]
	...
	for i in self.parser.sections():
		...
		elif j in ['login','passw','enc','downloaddir','customban','descr','pic','logsdir','incompletedir', 'autoreply', 'afterfinish', 'afterfolder', 'default', 'chatfont'] or (i == "ui" and j not in ["roomlistcollapsed", "tabclosers",  'buddylistinchatrooms', "trayicon"]):
