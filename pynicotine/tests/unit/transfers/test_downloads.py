...
class DownloadsTest(TestCase):
    ...
    def test_download_folder_destination(self):
        ...
        self.assertEqual(destination_custom, os.path.join(base, "Hello Test Path", "Path"))
        self.assertEqual(destination_custom_second, os.path.join(base, "Hello Test Path 2", "Path"))
