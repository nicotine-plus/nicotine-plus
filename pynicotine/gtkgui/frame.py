...
class NicotineFrame(UserInterface):
    ...
    def __init__(self, application, core, use_trayicon, start_hidden, bindip, port, ci_mode):
        ...
        (self.alt_speed_icon, self.buddy_list_container, self.chatrooms_buddy_list_container, self.chatrooms_container,
         self.chatrooms_end, self.chatrooms_entry, self.chatrooms_notebook, self.chatrooms_page, self.chatrooms_paned,
         self.chatrooms_status_page, self.chatrooms_title, self.chatrooms_toolbar, self.chatrooms_toolbar_contents,
         self.connections_label, self.download_files_button, self.download_files_label, self.download_status_label,
         self.download_users_button, self.download_users_label, self.downloads_content, self.downloads_end,
         self.downloads_expand_button, self.downloads_expand_icon, self.downloads_grouping_button, self.downloads_page,
         self.downloads_status_page, self.downloads_title, self.downloads_toolbar, self.downloads_toolbar_contents,
         self.header_bar, self.header_end, self.header_end_container, self.header_menu, self.header_title,
         self.horizontal_paned, self.interests_container, self.interests_end, self.interests_page,
         self.interests_title, self.interests_toolbar, self.interests_toolbar_contents, self.log_container,
         self.log_history_button, self.log_search_bar, self.log_search_entry, self.log_view, self.notebook,
         self.private_end, self.private_entry, self.private_history_button, self.private_notebook, self.private_page,
         self.private_status_page, self.private_title, self.private_toolbar, self.private_toolbar_contents,
         self.room_list_button, self.room_search_combobox, self.room_search_entry, self.scan_progress_bar,
         self.search_combobox, self.search_end, self.search_entry, self.search_mode_button, self.search_mode_label,
         self.search_notebook, self.search_page, self.search_status_page, self.search_title, self.search_toolbar,
         self.search_toolbar_contents, self.status_label, self.upload_files_button, self.upload_files_label,
         self.upload_status_label, self.upload_users_button, self.upload_users_label, self.uploads_content,
         self.uploads_end, self.uploads_expand_button, self.uploads_expand_icon, self.uploads_grouping_button,
         self.uploads_page, self.uploads_status_page, self.uploads_title, self.uploads_toolbar,
         self.uploads_toolbar_contents, self.user_search_combobox, self.user_search_entry, self.user_status_button,
         self.user_status_label, self.userbrowse_combobox, self.userbrowse_end, self.userbrowse_entry,
         self.userbrowse_notebook, self.userbrowse_page, self.userbrowse_status_page, self.userbrowse_title,
         self.userbrowse_toolbar, self.userbrowse_toolbar_contents, self.userinfo_combobox, self.userinfo_end,
         self.userinfo_entry, self.userinfo_notebook, self.userinfo_page, self.userinfo_status_page,
         self.userinfo_title, self.userinfo_toolbar, self.userinfo_toolbar_contents, self.userlist_content,
         self.userlist_end, self.userlist_page, self.userlist_status_page, self.userlist_title, self.userlist_toolbar,
         self.userlist_toolbar_contents, self.vertical_paned, self.window) = self.widgets
