...
class PrivateChat:
    ...
    def set_log_config(self, user, log_active):
        ...
        if log_active:
            if user not in config.sections["logging"]["private_users"]:
                config.sections["logging"]["private_users"].append(user)
        else:
            if user in config.sections["logging"]["private_users"]:
                config.sections["logging"]["private_users"].remove(user)
