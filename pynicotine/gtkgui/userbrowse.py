...
class UserBrowse:
    ...
    def rebuild_model(self):
        ...
        if opened == "0":
            ...
            shared_percentage = round((num_private_folders / num_folders) * 100)
        percentagestr = str(shared_percentage)
        # n00bi = "Private : " + privstr + " / " + "Total : " + totalstr
        n00bi = "Private: " + privstr + " / " + "Open: " + opened + " / " + percentagestr + "% Shared"
