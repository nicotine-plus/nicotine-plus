...
#
# Stole several code blocks from dkuhlman's examples
# If you're learning Python, check out his Python 101 page
# http://www.rexx.com/~dkuhlman/python_101/
...
def ClearDialog(frame, title=_("Nicotine+"), message="", default_text='',
	...
	win = OptionDialog(frame, message, modal=modal, status=status, option=False, third=third)
