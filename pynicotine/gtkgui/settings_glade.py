...
class ServerFrame:
	def __init__(self, create = True, accel_group = None, tooltips = None):
		...
		self.label172 = gtk.Label(_("Use the first available listening port from the following range:"))
...
class BloatFrame:
	def __init__(self, create = True, accel_group = None, tooltips = None):
		...
		self.ShowTooltips = gtk.CheckButton()
		self.tooltips.set_tip(self.ShowTooltips, _("Hey, you really should disable this!"))
		self.ShowTooltips.set_label(_("Show tooltips"))
		self.ShowTooltips.show()

		self.vboxUI.pack_start(self.ShowTooltips, False, False, 0)
...
class LogFrame:
	def __init__(self, create = True, accel_group = None, tooltips = None):
		...
		self.hbox31.pack_start(self.RoomLogLines, False, True, 0)
		...
		self.hbox177.pack_start(self.PrivateLogLines, False, True, 0)

		self.label38 = gtk.Label(_("lines"))
		self.label38.show()
		self.hbox177.pack_start(self.label38, False, True, 0)
...
class SearchFrame:
	def __init__(self, create = True, accel_group = None, tooltips = None):
		...
		self.hbox36.show()
		self.hbox36.set_spacing(5)

		self.ToggleDistributed = gtk.CheckButton()
		self.ToggleDistributed.set_label(_("Toggle responding to distributed searches every"))
		self.ToggleDistributed.show()
		self.ToggleDistributed.connect("toggled", self.OnToggleDistributed)
		...
		self.hbox36.pack_start(self.ToggleDistributedInterval, False, True, 0)

		self.secondsLabel = gtk.Label(_("seconds"))
		...
		self.ReopenTabs = gtk.CheckButton()
		self.ReopenTabs.set_alignment(0, 0)
		self.ReopenTabs.set_label(_("Reopen closed search tabs that haven't been ignored\nwhen new results come in"))
...
class EventsFrame:
	def __init__(self, create = True, accel_group = None, tooltips = None):
		...
		self.alignment10 = gtk.Alignment(0, 0.5, 0, 0)
		self.alignment10.set_padding(0, 0, 12, 0)
		self.alignment10.show()

		self.DCVBox = gtk.VBox(False, 0)
		self.DCVBox.show()

		self.DownloadDCBox = gtk.HBox(False, 0)
		self.DownloadDCBox.show()
		self.DownloadDCBox.set_spacing(5)

		self.label42 = gtk.Label(_("Download transfers"))
		self.label42.set_alignment(0, 0.50)
		self.label42.show()
		self.DownloadDCBox.pack_start(self.label42)

		self.DownloadDoubleClick_List = gtk.ListStore(gobject.TYPE_STRING)
		self.DownloadDoubleClick = gtk.ComboBox()
		self.DownloadDoubleClick.show()
		for i in [_("Nothing"), _("Send to player"), _("Open Directory"), _("Search"), _("Abort"), _("Clear"), _("Retry")]:
			self.DownloadDoubleClick_List.append([i])

		self.DownloadDoubleClick.set_model(self.DownloadDoubleClick_List)
		cell = gtk.CellRendererText()
		self.DownloadDoubleClick.pack_start(cell, True)
		self.DownloadDoubleClick.add_attribute(cell, 'text', 0)
		self.DownloadDCBox.pack_start(self.DownloadDoubleClick, False, True, 0)

		self.DCVBox.pack_start(self.DownloadDCBox)

		self.UploadDCBox = gtk.HBox(False, 0)
		self.UploadDCBox.show()
		self.UploadDCBox.set_spacing(5)

		self.label13 = gtk.Label(_("Upload transfers"))
		self.label13.set_alignment(0, 0.50)
		self.label13.show()
		self.UploadDCBox.pack_start(self.label13)

		self.UploadDoubleClick_List = gtk.ListStore(gobject.TYPE_STRING)
		self.UploadDoubleClick = gtk.ComboBox()
		self.UploadDoubleClick.show()
		for i in [_("Nothing"), _("Send to player"), _("Open Directory"), _("Search"), _("Abort"), _("Clear")]:
			self.UploadDoubleClick_List.append([i])

		self.UploadDoubleClick.set_model(self.UploadDoubleClick_List)
		cell = gtk.CellRendererText()
		self.UploadDoubleClick.pack_start(cell, True)
		self.UploadDoubleClick.add_attribute(cell, 'text', 0)
		self.UploadDCBox.pack_start(self.UploadDoubleClick, False, True, 0)

		self.DCVBox.pack_start(self.UploadDCBox)

		self.alignment10.add(self.DCVBox)

		self.frame2.add(self.alignment10)

		self.label45 = gtk.Label("")
		self.label45.set_markup(_("Double-clicking on..."))
		self.label45.show()
...
class NotebookFrame:
	def __init__(self, create = True, accel_group = None, tooltips = None):
		...
		self.tooltips.enable()
		if create:
			self.NotebookFrame = gtk.Window()
			self.NotebookFrame.set_title(_("Notebooks"))
		...
		self.vboxUI2.show()
		self.vboxUI2.set_spacing(5)
		self.vboxUI2.set_border_width(5)
		...
		self.hbox42.show()
		self.hbox42.set_spacing(5)

		self.image25 = gtk.Image()
		self.image25.set_from_stock(gtk.STOCK_CLOSE, 4)
		self.image25.show()
		self.hbox42.pack_start(self.image25)

		self.label30 = gtk.Label(_("Close-buttons on tabs"))
		self.label30.show()
		self.hbox42.pack_start(self.label30)

		self.TabClosers.add(self.hbox42)
		...
		self.vboxUI2.pack_start(self.mNoteHBox, False, True, 0)
		...
		self.vboxUI2.pack_start(self.cNoteHBox, False, True, 0)
		...
		self.vboxUI2.pack_start(self.pNoteHBox, False, True, 0)
		...
		self.vboxUI2.pack_start(self.SNoteHBox, False, True, 0)
		...
		self.vboxUI2.pack_start(self.iNoteHBox, False, True, 0)
...
class ColoursFrame:
	def __init__(self, create = True, accel_group = None, tooltips = None):
		...
		self.vboxColours = gtk.VBox(False, 0)
		self.vboxColours.show()
		self.vboxColours.set_spacing(3)

		self.ColorButtonsHbox = gtk.HBox(False, 0)
		self.ColorButtonsHbox.show()
		self.ColorButtonsHbox.set_spacing(5)
		...
		self.ColorButtonsHbox.pack_start(self.DefaultColours, False, True, 5)
		...
		self.ColorButtonsHbox.pack_start(self.ClearAllColours, False, True, 5)

		self.vboxColours.pack_start(self.ColorButtonsHbox, False, True, 0)

		self.ChatExpander = gtk.Expander()
		self.ChatExpander.set_expanded(True)
		self.ChatExpander.show()
		self.ChatExpander.connect("activate", self.OnExpand)
		...
		self.label5.set_markup(_("<b>Chat colours</b>"))
		self.label5.show()
		self.ChatExpander.set_label_widget(self.label5)
		...
		self.image43.set_alignment(0, 0.50)
		...
		self.label121 = gtk.Label("")
		self.label121.set_markup(_("<b>List and search colours</b>"))
		self.label121.show()
		...
		self.TransparentExpander.connect("activate", self.OnExpand)

		self.vboxTrans = gtk.VBox(False, 0)
		self.vboxTrans.show()
		self.vboxTrans.set_spacing(3)
		self.vboxTrans.set_border_width(3)
		...
		self.label343.show()
		self.vboxTrans.pack_start(self.label343, False, False, 0)
		...
		self.vboxTrans.pack_start(self.EnableTransparent, False, False, 0)
		...
		self.vboxTrans.pack_start(self.hbox202)

		self.TransparentExpander.add(self.vboxTrans)
