 ...
 * Try to find small, maintainable dependencies that can be bundled with the Nicotine+ source code, and give attribution. External dependencies can behave surprisingly different on some systems, and be quite outdated on some older systems.
...
Nicotine+ tries to follow [Semantic Versioning](https://semver.org/) when possible. As cited from the specification:
...
```
 ...
 8. Create a new release on [Flathub](https://github.com/flathub/org.nicotine_plus.Nicotine).
